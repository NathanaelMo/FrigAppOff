...
public class FridgeSummary {
  ...
  public FridgeSummary id(UUID id) {
    this.id = id;
    return this;
  }
  ...
  */
  ...
  public FridgeSummary name(String name) {
    this.name = name;
    return this;
  }
  ...
  */
  ...
  public FridgeSummary role(RoleEnum role) {
    this.role = role;
    return this;
  }
  ...
  */
  ...
  public FridgeSummary itemCount(Integer itemCount) {
  ...
  */
  ...
  public FridgeSummary memberCount(Integer memberCount) {
  ...
  */
  ...
  public FridgeSummary urgentCount(Integer urgentCount) {
  ...
  */
  ...
  public FridgeSummary updatedAt(OffsetDateTime updatedAt) {
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    FridgeSummary fridgeSummary = (FridgeSummary) o;
    return Objects.equals(this.id, fridgeSummary.id) &&
        Objects.equals(this.name, fridgeSummary.name) &&
        Objects.equals(this.role, fridgeSummary.role) &&
        Objects.equals(this.itemCount, fridgeSummary.itemCount) &&
        Objects.equals(this.memberCount, fridgeSummary.memberCount) &&
        Objects.equals(this.urgentCount, fridgeSummary.urgentCount) &&
        Objects.equals(this.updatedAt, fridgeSummary.updatedAt);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, name, role, itemCount, memberCount, urgentCount, updatedAt);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class FridgeSummary {\n");
