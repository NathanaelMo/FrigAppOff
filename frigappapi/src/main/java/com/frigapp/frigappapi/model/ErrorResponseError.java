...
public class ErrorResponseError {
  ...
  */
  ...
  @Schema(name = "code", example = "FRIDGE_NOT_FOUND", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("code")
  ...
  */
  ...
  @Schema(name = "message", example = "Le frigo demandé n'existe pas.", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
