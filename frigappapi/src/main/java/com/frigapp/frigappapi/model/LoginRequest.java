...
public class LoginRequest {
  ...
  */
  @NotNull @Email
  @Schema(name = "email", example = "nathanael@email.com", requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty("email")
  ...
  */
  @NotNull 
  @Schema(name = "password", example = "motdepasse123", requiredMode = Schema.RequiredMode.REQUIRED)
